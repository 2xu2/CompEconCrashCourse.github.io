...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // Function to change "Authors" to "Instructors"
  function changeAuthorsToInstructors() {
    const headings = document.querySelectorAll('.quarto-title-meta-heading');
    console.log("Found headings:", headings);
    headings.forEach(function(heading) {
      console.log("Checking heading:", heading.textContent.trim());
      if (heading.textContent.trim() === "Authors") {
        heading.textContent = "Instructors";
        console.log("Changed 'Authors' to 'Instructors'");
      }
    });
  }

  // Run the function once to catch the initial load
  changeAuthorsToInstructors();
});
</script>